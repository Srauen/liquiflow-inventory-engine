...
import { BrainCircuit, Send, Sparkles, Cpu } from 'lucide-react';
      ...
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-3xl font-bold flex items-center gap-3 uppercase tracking-tighter">
            ...
            Gemini Strategic Core
          </h1>
          <p className="text-gray-400 mt-2">
            Enterprise-grade inventory reasoning powered by Gemini 3 Pro.
            <span className="block text-xs text-neon-emerald mt-1 font-mono uppercase">Status: Live Intelligence Feed Active</span>
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1">
        ...
        <div className="lg:col-span-1 space-y-6">
          <GlassCard className="h-full flex flex-col">
            <h3 className="font-black text-xs uppercase tracking-[0.2em] mb-4 text-neon-blue">Scenario Parameters</h3>
            <div className="flex-1">
              <textarea 
                ...
                placeholder="Example: 'Evaluate the capital erosion risk of holding SKU-2077 for another 60 days vs a 15% immediate B2B exit.'"
                value={query}
            ...
            <div className="mt-4 flex justify-between items-center">
              ...
              <button 
                ...
                disabled={isThinking}
                className="px-6 py-3 bg-white text-black font-black text-[10px] uppercase tracking-widest rounded hover:bg-neon-blue transition-all disabled:opacity-50"
              >
          ...
          <GlassCard className="h-full flex flex-col relative overflow-hidden bg-gradient-to-br from-white/5 to-black/80">
            {isThinking && (
              <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-black/80 backdrop-blur-xl">
                ...
                <p className="text-neon-blue font-mono animate-pulse uppercase tracking-[0.2em] text-[10px] font-black">Consulting Gemini Strategic Core...</p>
                <p className="text-[9px] text-gray-600 mt-2 font-mono uppercase">Calculating Multi-Variable Liquidity Scenarios</p>
              </div>
            )}
            
            <div className="flex items-center gap-2 mb-6 border-b border-white/5 pb-4">
              <BrainCircuit className="w-5 h-5 text-neon-violet" />
              <h3 className="font-black text-xs uppercase tracking-[0.2em]">Strategic Intelligence Output</h3>
            </div>
              ...
              {response ? (
                <div className="prose prose-invert max-w-none">
                  <p className="font-mono text-[9px] text-gray-600 mb-4 uppercase tracking-widest">
                    SESSION_ID: {Math.random().toString(16).slice(2, 10).toUpperCase()} // CORE: GEMINI-3-PRO
                  </p>
                ...
                <div className="h-full flex flex-col items-center justify-center text-gray-800">
                  ...
                  <p className="font-mono text-[10px] uppercase tracking-[0.3em] font-black">Awaiting input stream...</p>
                </div>
              )}
            </div>
          </GlassCard>
